...
import type { Key, TableRowSelection as ITableRowSelection } from 'antd/lib/table/interface';
...
import { Fn, Nullable, Recordable } from '#/global';
...
export interface TableRowSelection<T = any> extends Omit<ITableRowSelection<any>, 'onChange'> {
  /**
...
type BasicTableExtraProps = TableHeaderProps & TableFooterProps & TableActionProps;
...
export interface BasicTableProps<T = any> extends BasicTableExtraProps {
   ...
   * @type Function
   */
  customHeaderRow?: (column: ColumnProps<any>, index: number) => object;
  ...
  onFetchSuccess?: (params: { items: Recordable<any>[]; total: number }) => void;
  onFetchError?: (err: any) => void;
  onSelectionChange?: (params: { keys: Key[]; rows: Recordable[] }) => void;
  register?: (table: TableActionType, form: FormActionType) => void;
  onRowClick?: (reacord: Recordable<any>, index: number, e: any) => void;
  onRowDbClick?: (reacord: Recordable<any>, index: number, e: any) => void;
  onRowContextMenu?: (reacord: Recordable<any>, index: number, e: any) => void;
  onRowMouseEnter?: (reacord: Recordable<any>, index: number, e: any) => void;
  onRowMouseLeave?: (reacord: Recordable<any>, index: number, e: any) => void;
  onEditEnd?: (data: { record: any; index: number; key: string; value: any }) => void;
  onEditCancel?: (data: { record: any; index: number; key: string; value: any }) => void;
  onEditChange?: (data: { column: BasicColumn; value: any; record: any }) => void;
  onEditRowwEnd?: () => void;
}
